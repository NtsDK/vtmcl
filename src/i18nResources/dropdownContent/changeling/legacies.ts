...
const unseelieArr = [...generateEnRuEntities(generateSequence(2, unseelieSource))];
const nightmareArr = [...generateEnRuEntities(generateSequence(2, nightmareSource))];
...
const legacyGroupsArr = [...generateIdEnRuEntities(generateSequence(3, legacyGroupsSource))];

const groupNames = R.indexBy(R.prop('id'), legacyGroupsArr) as Record<LegacyGroups, IdEnRuEntity>;
