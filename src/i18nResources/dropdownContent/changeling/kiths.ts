...
const kithainArr = [...generateEnRuEntities(generateSequence(2, kithainSource))];
const thallainArr = [...generateEnRuEntities(generateSequence(2, nunnehiSource))];
const nunnehiArr = [...generateEnRuEntities(generateSequence(2, thallainSource))];
...
const kithGroupsArr = [...generateIdEnRuEntities(generateSequence(3, kithGroupsSource))];

const groupNames = R.indexBy(R.prop('id'), kithGroupsArr) as Record<KithsGroups, IdEnRuEntity>;
