...
export const validateDisciplinePathEntity = ajv.compile(disciplinePathEntitySchema);
...
const sourceArr = [...generateDisciplinePathEntities(generateSequence(3, disciplinePathsSource))];
...
const disciplinePathGroupsArr = [...generateIdEnRuEntities(generateSequence(3, disciplinePathGroupsSource))];
