...
import { clansSource, clanGroupsSource, bloodlinesSource } from "./clansSource";
...
type ClanGroupName = "high-clan" | "low-clan" | "bloodline";
...
export const clanEntitySchema: JSONSchemaType<ClanEntity> = {
  ...
  properties: {
    ...
    groupName: {
      type: "string",
      enum: ["high-clan", "low-clan", "bloodline"],
    },
  },
...
const sourceArr = [
  ...generateClanEntities(
    generateSequence(3, clansSource + "\n" + bloodlinesSource)
  ),
];
...
const groupOrder: ClanGroupName[] = ["high-clan", "low-clan", "bloodline"];
